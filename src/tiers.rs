...
//!
//! `scala --tiers Main.scala` prints the report.
...
pub struct ChunkTiers {
    /// Which chunk this is — `main` for a whole Scala program.
    pub name: String,
...
/// has gone round enough times to be recorded. scalars writes program output
...
const PROGRAM: &str = "object Main {\n def f(n: Int): Int = { var t = 0; var i = 0; while (i < n) { t += i; i += 1 }; t }\n def main(a: Array[String]): Unit = println(f(200000))\n}";
